...
import 'package:crossfit_kabod_app/features/chat/presentation/widget/full_photo.dart';
import 'package:crossfit_kabod_app/features/chat/presentation/widget/loading.dart';
...
class ChatScreenState extends State<ChatScreen> {
  ...
  Widget buildSticker() {
    return Container(
      ...
      decoration: BoxDecoration(
          border:
              Border(top: BorderSide(color: AppColors.labelColor, width: 0.5)),
          color: AppColors.labelColor),
  ...
  Widget buildInput() {
    return Container(
      ...
      decoration: BoxDecoration(
          border:
              Border(top: BorderSide(color: AppColors.textColor, width: 0.5)),
          color: Colors.white),
    );
  }
