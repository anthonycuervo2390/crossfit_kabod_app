...
import 'package:crossfit_kabod_app/features/chat/presentation/pages/chat.dart';
              ...
              Material(
                child: document.data()['photo_url'] != null
                    ? CachedNetworkImage(
                        ...
                        imageUrl: document.data()['photo_url'],
                        width: 50.0,
                        height: 50.0,
                        fit: BoxFit.cover,
                      )
                ...
                child: Container(
                  child: Column(
                    children: <Widget>[
                      Container(
                        child: Text(
                          'Name: ${document.data()['name'] ?? 'Anonymous'}',
                          style: TextStyle(
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => Chat(
                          peerId: document.id,
                          peerAvatar: document.data()['photo_url'],
                        )));
          },
